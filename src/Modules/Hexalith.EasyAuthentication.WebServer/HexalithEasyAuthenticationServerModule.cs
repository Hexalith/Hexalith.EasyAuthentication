namespace Hexalith.EasyAuthentication.WebServer;
...
using Hexalith.EasyAuthentication.WebServer.Middlewares;
...
/// </summary>
public sealed class HexalithEasyAuthenticationServerModule : IWebServerApplicationModule
{
    /// <inheritdoc/>
